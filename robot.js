...
const MARKETS=[
  ...
  {key:"over5",name:"Over 5+",patterns:[/o5@?(\d+[,.]\d+)/ig,/5\+@?(\d+[,.]\d+)/ig,/over\s*5@?(\d+[,.]\d+)/ig],label:/5\+|over\s*5/i},
  {key:"casa5",name:"Casa 5+",patterns:[/casa\s*5@?(\d+[,.]\d+)/ig,/c5@?(\d+[,.]\d+)/ig],label:/casa\s*5/i},
  {key:"fora5",name:"Fora 5+",patterns:[/fora\s*5@?(\d+[,.]\d+)/ig,/f5@?(\d+[,.]\d+)/ig],label:/fora\s*5/i}
];
